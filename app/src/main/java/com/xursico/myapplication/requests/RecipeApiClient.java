...
import com.xursico.myapplication.AppExecutors;
...
import static com.xursico.myapplication.util.Constants.NETWORK_TIMEOUT;
    ...
    public void searchRecipeById(String recipeId) {
        ...
        AppExecutors.getInstance().networkIO().schedule(new Runnable() {
            ...
            public void run() {
                ...
                mRecipeRequestTimeout.setValue(true);
                handler.cancel(true);
            }
        }, NETWORK_TIMEOUT, TimeUnit.MILLISECONDS);
